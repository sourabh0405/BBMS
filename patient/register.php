...
if(isset($_POST['register'])){
    ...
    $query = "insert into patients values(null,'$_POST[name]','$_POST[email]','$_POST[password]','$_POST[mobile]','$_POST[city]')";
            ...
            <div class="col-md-4 mx-auto" id="login-container">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="city" placeholder="place." required>
                    </div>
