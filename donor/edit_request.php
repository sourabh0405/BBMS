...
<nav class="navbar bg-danger">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" style="color: white;" href="">RedCross Donar</a>
        </div>
        ...
        <!-- <li class="nav-item">
            <a class="nav-link" id="history">History</a>
        </li> -->
        <li class="nav-item">
            <a class="nav-link" href="" id="print_certificate">Print Certificate</a>
        </li>
        <li class="nav-item">
